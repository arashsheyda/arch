...
<template>
  <footer absolute w-full bottom-0 left-0 right-0 text-base font-medium>
    <div flex :justify="!arch.footer!.poweredBy && !arch.footer!.links!.length ? 'center' : 'between'" p4 mx4 border="t base">
      <div v-if="arch.footer!.poweredBy">
      ...
      <div>
        &lt;Coded by
        <NuxtLink :to="arch.footer!.copyright!.link" text-primary>
